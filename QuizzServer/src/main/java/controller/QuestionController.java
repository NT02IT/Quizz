...
public class QuestionController implements Initializable {
	...
	private boolean checkEmptySubjectName() {

		return subject_Name_Question.getText() == null || subject_Name_Question.getText() == "";
	}

	private boolean checkEmptySubjectID() {
	...
	void button_Create_Subject_Question(ActionEvent event) {
		...
		if (checkEmptySubjectID()) {
			Notification.Infomation(Notification.Default, "SubjectID rỗng");
			return;
		}
		if (checkEmptySubjectName()) {
